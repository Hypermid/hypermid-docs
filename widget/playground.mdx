...
<iframe
  ...
  style={{ border: "none", borderRadius: 12, marginTop: 8, marginBottom: 24, boxShadow: "0 4px 24px rgba(0,0,0,0.08)" }}
></iframe>

<Tip>
  Need more room? Open the playground in its own tab: [app.hypermid.io/widget/playground →](https://app.hypermid.io/widget/playground)
</Tip>
...
<CardGroup cols={2}>
  ...
  <Card title="Partner attribution" icon="handshake">
    Set `partnerId` for fee tracking and analytics. Optionally hide the "Powered by Hypermid" footer (subject to partnership agreement).
  </Card>
</CardGroup>
