...
<Card
  ...
  horizontal
>
  Launch the full playground in a new tab. **No signup required.** Tune accents, success/error colors, typography, border radius, chains, and layout — copy the embed code when you're done.
</Card>
