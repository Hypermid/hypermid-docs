...
<Tip>
  **Some PulseChain routes** require a confirmation step after the transaction. If the quote response includes `afterStep1`, see [Confirm Deposit](/api-reference/confirm-deposit).
</Tip>
