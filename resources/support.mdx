...
If you're a partner with an API key, you have access to priority support through the [Partner Portal](https://partner.hypermid.io/login):
...
Rate limits are two-bucket — see the [Authentication](/authentication) page for the full table. Common patterns:
