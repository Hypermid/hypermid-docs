...
`}</style>
  <div className="hypermid-arch-embed">

{/* Swap Lifecycle */}
<div>
  <div className="diagram-title" style={{ marginBottom: 20 }}>Swap lifecycle</div>
  <div className="lifecycle">
    <div className="phase">
      <div className="phase-num">01</div>
      <div className="phase-name">Discovery</div>
      <div className="phase-desc">Chains & tokens</div>
    </div>
    <div className="arrow-sep">→</div>
    <div className="phase">
      <div className="phase-num">02</div>
      <div className="phase-name">Quote</div>
      <div className="phase-desc">Best route & price</div>
    </div>
    <div className="arrow-sep">→</div>
    <div className="phase">
      <div className="phase-num">03</div>
      <div className="phase-name">Execute</div>
      <div className="phase-desc">Sign & broadcast</div>
    </div>
    <div className="arrow-sep">→</div>
    <div className="phase">
      <div className="phase-num">04</div>
      <div className="phase-name">Track</div>
      <div className="phase-desc">Poll status</div>
    </div>
  </div>
</div>
...
{/* Architecture */}
<div>
  <div className="diagram-title" style={{ marginBottom: 20 }}>Architecture</div>
  <div className="architecture">
    <div className="user-box">User / dApp / Swap Widget</div>
    <div className="connector"></div>

    <div className="engine-box">
      <div className="engine-label">⚡ Hypermid Smart Routing Engine</div>
      <div className="bridges">
        <div className="bridge">
          <div className="bridge-name">EVM / SOL Bridge</div>
          <div className="bridge-desc">Liquidity pools</div>
        </div>
        <div className="bridge">
          <div className="bridge-name">Intent Bridge</div>
          <div className="bridge-desc">Solver network</div>
        </div>
        <div className="bridge">
          <div className="bridge-name">Warp Routes</div>
          <div className="bridge-desc">Cross-chain transfers</div>
        </div>
      </div>
    </div>
    ...
    <div className="chains-box">
      <div className="chains-label">90+ Supported Blockchains</div>
      <div className="chains-grid">
        <div className="chain-pill"><span className="chain-dot" style={{ background: "#627eea" }}></span>Ethereum</div>
        <div className="chain-pill"><span className="chain-dot" style={{ background: "#14f195" }}></span>Solana</div>
        <div className="chain-pill"><span className="chain-dot" style={{ background: "#f7931a" }}></span>Bitcoin</div>
        <div className="chain-pill"><span className="chain-dot" style={{ background: "#00aae4" }}></span>XRP</div>
        <div className="chain-pill"><span className="chain-dot" style={{ background: "#bfbbbb" }}></span>Litecoin</div>
        <div className="chain-pill"><span className="chain-dot" style={{ background: "#0098ea" }}></span>TON</div>
        <div className="chain-pill"><span className="chain-dot" style={{ background: "#28a0f0" }}></span>Arbitrum</div>
        <div className="chain-pill"><span className="chain-dot" style={{ background: "#0052ff" }}></span>Base</div>
        <div className="chain-pill"><span className="chain-dot" style={{ background: "#8247e5" }}></span>Polygon</div>
        <div className="chain-pill"><span className="chain-dot" style={{ background: "#ff0420" }}></span>Optimism</div>
        <div className="chain-pill"><span className="chain-dot" style={{ background: "#f0b90b" }}></span>BSC</div>
        <div className="chain-pill"><span className="chain-dot" style={{ background: "#e84142" }}></span>Avalanche</div>
      </div>
      <div className="chains-more">+ PulseChain, Fantom, Gnosis, zkSync, Linea, Scroll, Mantle, and 75+ more</div>
    </div>
  </div>
</div>
