...
```mermaid
flowchart TD
    U["👤 User / dApp / Swap Widget"] --> R
 
    subgraph R["⚡ Hypermid Smart Routing Engine"]
        direction LR
        B1["EVM / SOL Bridge\nLiquidity pools"]
        B2["Intent Bridge\nSolver network"]
    ...
    R --> C5["Litecoin"]
    R --> C6["TON"]
    R --> C7["Arbitrum, Base, Polygon\n& 80+ more"]
 
    style U fill:#0f0f23,stroke:#6c63ff,color:#fff
    style R fill:#111128,stroke:#00d2ff,color:#fff
    style B1 fill:#1a1a3e,stroke:#7c4dff,color:#fff
    style B2 fill:#1a1a3e,stroke:#ff6b6b,color:#fff
    style B3 fill:#1a1a3e,stroke:#ffa726,color:#fff
    style C1 fill:#1a1a2e,stroke:#627eea,color:#fff
    style C2 fill:#1a1a2e,stroke:#14f195,color:#fff
    style C3 fill:#1a1a2e,stroke:#f7931a,color:#fff
    style C4 fill:#1a1a2e,stroke:#00aae4,color:#fff
    style C5 fill:#1a1a2e,stroke:#bfbbbb,color:#fff
    style C6 fill:#1a1a2e,stroke:#0098ea,color:#fff
    style C7 fill:#1a1a2e,stroke:#555,color:#aaa
```
